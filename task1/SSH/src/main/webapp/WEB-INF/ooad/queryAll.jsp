...
<!-- 				<input type="hidden" name="pageNum" value="1"> -->
				...
				topwood:<input type="text" name="topwood" id="topwood" style="width: 120px"
					value="${topwood}" placeholder="topwood" /> &nbsp;
				backwood:<input type="text" name="backwood" id="backwood" style="width: 120px"
					value="${backwood}" placeholder="backwood" /> &nbsp;
				type:<input type="text" name="type" id="type" style="width: 120px"
					value="${type}" placeholder="类型" /> &nbsp;
				builder:<input type="text" name="builder" id="builder" style="width: 120px"
					value="${builder}" placeholder="builder" /> &nbsp;<br/>
				model:<input type="text" name="guitarmodel" id="model" style="width: 120px"
			...
			<table border="1px" cellspacing="0px"
				...
				<c:forEach items="${result.dataList}" var="guitar">
					<tr>
						...
						<td><c:out value="${guitar.backwood }"></c:out></td>
						<td><c:out value="${guitar.topwood }"></c:out></td>
						<td><c:out value="${guitar.type }"></c:out></td>
						<td><c:out value="${guitar.builder }"></c:out></td>
						<td><c:out value="${guitar.guitarmodel }"></c:out></td>
					</tr>
				</c:forEach>
			</table>
			<br>
